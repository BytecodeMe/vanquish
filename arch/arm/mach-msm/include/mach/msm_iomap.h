...
#define MSM_SFAB_BASE		IOMEM(0xFA01C000)	/* 16K	*/
#define MSM_AFAB_BASE		IOMEM(0xFA020000)	/* 16K	*/
#define MSM_DAY_CFG_BASE	IOMEM(0xFA024000)	/* 16K	*/
#define MSM_FABRIC_MMSS_BASE	IOMEM(0xFA028000)	/* 16K	*/
