...
static char gamma_settings_nit[NUMBER_BRIGHTNESS_LEVELS][26] = {
	/* 10 nits*/
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x1D, 0x28, 0x3C, 0x6B, 0x6D,
	 0x6C, 0xC6, 0xCB, 0xB7, 0xC0,
	 0xCB, 0xA1, 0xCD, 0xDB, 0xD2,
	 0x00, 0x5E, 0x00, 0x56, 0x00, 0x70},
	/* 20 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x27, 0x32, 0x46, 0x99, 0x9C,
	 0x93, 0xCF, 0xD6, 0xB5, 0xB5,
	 0xC6, 0xAB, 0xCD, 0xD7, 0xCD,
	 0x00, 0x6B, 0x00, 0x62, 0x00, 0x7D},
	/* 30 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x3A, 0x45, 0x59, 0xAF, 0xB5,
	 0x9A, 0xCF, 0xD6, 0xB7, 0xAF,
	 0xC4, 0xB3, 0xCB, 0xD2, 0xC7,
	 0x00, 0x75, 0x00, 0x6C, 0x00, 0x88},
	/* 40 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x4F, 0x5A, 0x6E, 0xBB, 0xC4,
	 0x9D, 0xD0, 0xD7, 0xBA, 0xAC,
	 0xC1, 0xB6, 0xC7, 0xCF, 0xC2,
	 0x00, 0x7C, 0x00, 0x73, 0x00, 0x91},
	/* 50 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x61, 0x6C, 0x80, 0xC0, 0xCA,
	 0x9D, 0xCC, 0xD5, 0xBD, 0xAB,
	 0xBE, 0xB3, 0xC5, 0xCD, 0xBF,
	 0x00, 0x83, 0x00, 0x7A, 0x00, 0x99},
	/* 60 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x5C, 0x68, 0x76, 0xC2, 0xCC,
	 0xA3, 0xC9, 0xD4, 0xBF, 0xA9,
	 0xBC, 0xB0, 0xC2, 0xC9, 0xBB,
	 0x00, 0x89, 0x00, 0x80, 0x00, 0xA0},
	/* 70 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x71, 0x7E, 0x88, 0xC1, 0xCB,
	 0xA2, 0xC7, 0xD4, 0xC2, 0xA8,
	 0xB9, 0xAE, 0xC0, 0xC7, 0xB9,
	 0x00, 0x8F, 0x00, 0x86, 0x00, 0xA7},
	/* 80 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x6F, 0x7C, 0x83, 0xC0, 0xCA,
	 0xA1, 0xC5, 0xD3, 0xC5, 0xA7,
	 0xB7, 0xAB, 0xBF, 0xC7, 0xB8,
	 0x00, 0x94, 0x00, 0x8B, 0x00, 0xAD},
	/* 90 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x83, 0x91, 0x94, 0xBF, 0xC9,
	 0xA0, 0xC5, 0xD4, 0xC9, 0xA5,
	 0xB4, 0xA7, 0xBD, 0xC5, 0xB6,
	 0x00, 0x99, 0x00, 0x90, 0x00, 0xB3},
	/* 100 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x81, 0x8F, 0x8F, 0xBE, 0xC8,
	 0xA0, 0xC3, 0xD3, 0xCA, 0xA5,
	 0xB3, 0xA6, 0xBD, 0xC4, 0xB6,
	 0x00, 0x9D, 0x00, 0x94, 0x00, 0xB8},
	/* 110 nits*/
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x7E, 0x8D, 0x8A, 0xBF, 0xCA,
	 0xA5, 0xC2, 0xD2, 0xC8, 0xA4,
	 0xB2, 0xA4, 0xBB, 0xC2, 0xB4,
	 0x00, 0xA2, 0x00, 0x98, 0x00, 0xBD},
	/* 120 */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x8C, 0x9C, 0x94, 0xBD, 0xC9,
	 0xA7, 0xC2, 0xD2, 0xC9, 0xA3,
	 0xB0, 0xA2, 0xBB, 0xC2, 0xB4,
	 0x00, 0xA5, 0x00, 0x9C, 0x00, 0xC2},
	/* 130 */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x89, 0x9A, 0x8F, 0xBE, 0xCA,
	 0xAB, 0xC1, 0xD1, 0xC7, 0xA2,
	 0xAF, 0xA0, 0xBA, 0xC1, 0xB3,
	 0x00, 0xA9, 0x00, 0xA0, 0x00, 0xC6},
	/* 140 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x97, 0xA8, 0x99, 0xBD, 0xCA,
	 0xAD, 0xC1, 0xD0, 0xC6, 0xA2,
	 0xAE, 0xA0, 0xB9, 0xBF, 0xB2,
	 0x00, 0xAD, 0x00, 0xA4, 0x00, 0xCB},
	/* 150 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x94, 0xA7, 0x96, 0xBD, 0xCB,
	 0xB0, 0xC1, 0xD0, 0xC7, 0x9F,
	 0xAC, 0x9D, 0xB7, 0xBE, 0xB0,
	 0x00, 0xB1, 0x00, 0xA8, 0x00, 0xD0},
	/* 160 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x94, 0xA7, 0x96, 0xBB, 0xC9,
	 0xAE, 0xC1, 0xCF, 0xC5, 0x9F,
	 0xAB, 0x9C, 0xB5, 0xBC, 0xAE,
	 0x00, 0xB5, 0x00, 0xAC, 0x00, 0xD5},
	/* 170 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA2, 0xB5, 0xA0, 0xB8, 0xC8,
	 0xAE, 0xC2, 0xD0, 0xC6, 0x9E,
	 0xAA, 0x9B, 0xB5, 0xBC, 0xAE,
	 0x00, 0xB9, 0x00, 0xAF, 0x00, 0xD9},
	/* 180 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA0, 0xB3, 0x9D, 0xB9, 0xC8,
	 0xB1, 0xC1, 0xCF, 0xC5, 0x9C,
	 0xA9, 0x99, 0xB5, 0xBB, 0xAE,
	 0x00, 0xBC, 0x00, 0xB3, 0x00, 0xDD},
	/* 190 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA0, 0xB3, 0x9D, 0xB6, 0xC7,
	 0xAF, 0xC1, 0xCE, 0xC4, 0x9C,
	 0xA8, 0x99, 0xB4, 0xBA, 0xAC,
	 0x00, 0xBF, 0x00, 0xB6, 0x00, 0xE1},
	/* 200 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0x9E, 0xB2, 0x99, 0xB7, 0xC7,
	 0xB1, 0xC1, 0xCE, 0xC4, 0x9B,
	 0xA7, 0x97, 0xB2, 0xB9, 0xAB,
	 0x00, 0xC3, 0x00, 0xBA, 0x00, 0xE5},
	/* 210 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA6, 0xBB, 0x9F, 0xB7, 0xC8,
	 0xB4, 0xC1, 0xCD, 0xC3, 0x9A,
	 0xA7, 0x96, 0xB1, 0xB8, 0xAA,
	 0x00, 0xC6, 0x00, 0xBD, 0x00, 0xE9},
	/* 220 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA6, 0xBB, 0x9F, 0xB5, 0xC6,
	 0xB2, 0xC0, 0xCC, 0xC2, 0x99,
	 0xA5, 0x95, 0xB2, 0xB8, 0xAB,
	 0x00, 0xC9, 0x00, 0xC0, 0x00, 0xEC},
	/* 230 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xA4, 0xB9, 0x9B, 0xB5, 0xC7,
	 0xB4, 0xC1, 0xCC, 0xC2, 0x98,
	 0xA4, 0x94, 0xB1, 0xB7, 0xAA,
	 0x00, 0xCC, 0x00, 0xC3, 0x00, 0xF0},
	/* 240 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xAC, 0xC2, 0xA1, 0xB5, 0xC7,
	 0xB6, 0xC0, 0xCB, 0xC1, 0x98,
	 0xA4, 0x93, 0xB1, 0xB7, 0xAA,
	 0x00, 0xCF, 0x00, 0xC6, 0x00, 0xF3},
	/* 250 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xAC, 0xC2, 0xA1, 0xB3, 0xC6,
	 0xB4, 0xC1, 0xCC, 0xC1, 0x97,
	 0xA3, 0x93, 0xAF, 0xB5, 0xA7,
	 0x00, 0xD2, 0x00, 0xC9, 0x00, 0xF7},
	/* 260 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xAA, 0xC0, 0x9E, 0xB3, 0xC6,
	 0xB7, 0xC0, 0xCB, 0xC0, 0x97,
	 0xA3, 0x92, 0xAE, 0xB5, 0xA7,
	 0x00, 0xD5, 0x00, 0xCC, 0x00, 0xFB},
	/* 270 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xAA, 0xC0, 0x9E, 0xB1, 0xC5,
	 0xB5, 0xC1, 0xCB, 0xC1, 0x95,
	 0xA2, 0x91, 0xAE, 0xB4, 0xA7,
	 0x00, 0xD7, 0x00, 0xCE, 0x00, 0xFE},
	/* 280 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xB2, 0xC8, 0xA3, 0xB1, 0xC5,
	 0xB7, 0xC1, 0xCB, 0xC1, 0x94,
	 0xA0, 0x8F, 0xAE, 0xB4, 0xA7,
	 0x00, 0xDA, 0x00, 0xD1, 0x01, 0x01},
	/* 290 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xB2, 0xC8, 0xA3, 0xAF, 0xC4,
	 0xB5, 0xC1, 0xCA, 0xC0, 0x95,
	 0xA1, 0x90, 0xAD, 0xB3, 0xA6,
	 0x00, 0xDD, 0x00, 0xD4, 0x01, 0x04},
	/* 300 nits */
	{0xfa, 0x02, 0x51, 0x39, 0x55,
	 0xB0, 0xC7, 0xA0, 0xB0, 0xC5,
	 0xB8, 0xC2, 0xCB, 0xC1, 0x94,
	 0xA0, 0x8F, 0xAD, 0xB3, 0xA6,
...
static struct dsi_cmd_desc smd_qhd_429_cmds_2[] = {
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(gamma_settings_nit[NUMBER_BRIGHTNESS_LEVELS - 1]),
		 gamma_settings_nit[NUMBER_BRIGHTNESS_LEVELS - 1]},
...
static void panel_set_backlight(struct msm_fb_data_type *mfd)
{
	...
	set_brightness_cmds[0].payload = gamma_settings_nit[idx];
