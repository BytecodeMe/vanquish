...
int start_evfwdrel(void)
{
	...
	set_bit(BTN_TOUCH,	evfwdrel_input_dev->keybit);
...
DEVICE_ATTR(rel, 0644, NULL, write_evfwdrel);
...
void __exit evfwdrel_cleanup(void)
{
...
void __exit evfwdkbd_cleanup(void)
{
...
/* Attach the sysfs write method for keyboard events */
DEVICE_ATTR(abs, 0644, NULL, write_evfwdabs);
...
void __exit evfwdabs_cleanup(void)
{
